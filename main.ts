...
let answer = await inquirer.prompt([
  { name: "mypin", type: "number", message: "Enter your pin number" },
]);
  ...
  let answer2 = await inquirer.prompt([
    {
      name: "operation",
      type: "list",
      message: "Enter your required operation",
      choices: ["Withdraw", "Replenish", "CheckBalance"],
    },
  ]);
    ...
    let answer4 = await inquirer.prompt([
      {
        name: "money2",
        type: "number",
        message: "Enter your amount to Replenish",
      },
    ]);
